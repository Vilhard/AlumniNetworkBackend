...
namespace AlumniNetworkBackend.Models
{
    public class AlumniNetworkDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("server=5CG05206QY\\SQLEXPRESS;Initial Catalog=AlumniNetworkDB;trusted_connection=true;MultipleActiveResultSets=true");
        }
